...
public final class Bootstrap {
    ...
    private void initClassLoaders() {
        log.info("初始化三个loader commonLoader catalinaLoader and sharedLoader");
        try {
    ...
    /**
     * 这里默认是根据conf目录下面的catalina.properties文件里面配置common.loader server.loader shared.loader 加载jar包
     * @param name
     * @param parent
     * @return
     * @throws Exception
    ...
    /**
     * Load daemon.
     * 实际上去执行 org.apache.catalina.startup.Catalina.load方法
     */
