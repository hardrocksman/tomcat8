...
public class Catalina {
    ...
    public void load() {
        ...
        // Create and execute our Digester
        // server.xml的解析器   配置解析规则
        log.info("配置解析server.xml的解析规则");
        ...
        log.info("解析完成之后 会生成 StandardServer  将该类关联上Catalina");
        ...
        try {
            // 这里的server  是 org.apache.catalina.Server.StandardServer
            // createStartDigester方法的setnext应该就是调用这个类的setServer方法
            log.info("调用StandardServer init方法");
            getServer().init();
        } catch (LifecycleException e) {
